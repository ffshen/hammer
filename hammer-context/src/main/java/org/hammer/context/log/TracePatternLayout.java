...
public class TracePatternLayout extends PatternLayout {
    ...
    static {
        ...
        defaultConverterMap.put("X",  org.hammer.context.log.MDCConverter.class.getName());
        defaultConverterMap.put("mdc", org.hammer.context.log.MDCConverter.class.getName());
